...
Revision ID: 3c5bd82a31fb
Revises: 0c6bde0be0b1
Create Date: 2025-05-15 16:49:59.109859
...
revision: str = '3c5bd82a31fb'
down_revision: Union[str, None] = '0c6bde0be0b1'
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['form_id'], ['forms.form_id'], ),
    sa.PrimaryKeyConstraint('form_id', 'section_id')
    )
