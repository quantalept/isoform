"""Your reference message

Revision ID: dc5f1b7db952
Revises: b25c5e5c0e7d
Create Date: 2025-05-15 16:40:14.463191
...
revision: str = 'dc5f1b7db952'
down_revision: Union[str, None] = 'b25c5e5c0e7d'
...
def upgrade() -> None:
    ...
    sa.Column('logic_id', sa.Integer(), nullable=False),
    sa.Column('form_id', sa.UUID(), nullable=False),
